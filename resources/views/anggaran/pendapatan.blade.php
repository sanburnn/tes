@extends('layouts.app')
@section('title', isset($title) ? $title : 'Pendapatan - Yayasan Miftahul Huda')
@section('content')
      ...
      <div class="card border-left-info shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Anggaran Pendapatan</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800">{{ separate($total_anggaran_pendapatan) }}</div>
            </div>
    ...
    <div class="col-xl-4 col-md-6 mb-4">
      <div class="card border-left-warning shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Pendapatan</div>
    ...
    <div class="col-xl-4 col-md-6 mb-4">
      <div class="card border-left-danger shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">SELISIH</div>
                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ separate($selisih) }}</div>
            </div>
            <div class="col-auto font-weight-bold text-gray-800 h1">
              <i class="fa fa-solid fa-wallet"></i>
            </div>
      ...
      <div class="card demo-icons">
        <div class="card-header">
          <div class="row">
            ...
            <p class="card-category">Daftar pendapatan yang ada di setiap sekolah dibawah naungan
          ...
          <div id="accordion">
            <div class="card">
              ...
              <div id="collapseOne" class="collapse @if ($errors->has('pendapatan') || $errors->has('sub_pendapatan') || $errors->has('jumlah')) show @endif" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="card-body">
                  <form class="user" method="POST" action="{{ route('anggaran.store') }}">
                    @csrf
                    <div class="row">
                      <div class="col-md-6">
                          <label>Sekolah</label>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" value="{{ old('sub_pendapatan') }}" name="sub_pendapatan" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" id="jumlah" class="form-control" value="{{ old('jumlah') }}" onkeyup="formatUang(this)" name="jumlah" autocomplete="off">
                          @error('jumlah')
                            <span class="text-danger">{{ $message }}</span>
                          @enderror
                        </div>
                ...
                <div class="card-body">
                  <table class="table" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        ...
                        <th style="width: 20%">Sub Pendapatan</th>
