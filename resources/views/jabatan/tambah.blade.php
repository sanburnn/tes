@extends('layouts.app')
@section('title', isset($title) ? $title : 'Tambah Jabatan - Yayasan Miftahul Huda')
@section('content')
  ...
  <div class="row">
    <div class="col-md-12"> 
      <div class="card demo-icons">
        ...
        <div class="card-body">
          <form class="user" method="POST" enctype="multipart/form-data" action="{{ route('jabatan.store') }}">
            @csrf
            <div class="row">
              <div class="col-md-12">
