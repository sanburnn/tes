@extends('layouts.app')
@section('title', isset($title) ? $title : 'Tambah SPP Siswa - Yayasan Miftahul Huda')
@section('content')
  ...
  <div class="row">
    <div class="col-md-12"> 
      <div class="card demo-icons">
        ...
        <div class="card-body">
          <form class="user" method="POST" action="{{ route('spp.store') }}">
            @csrf
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label>SPP (Rupiah) <span class="text-danger">*</span></label>
                  <input type="text" id="nilai" onkeyup="formatUang(this)" class="form-control" value="{{ old('nilai') }}" name="nilai" autocomplete="off">
                  @error('nilai')
